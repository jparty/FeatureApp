...
The code from this class is taken from the following website :
...
/**
 * This class is used to create a personalize seekbar to choose to value of the
 * accuracy of the selection of the end of a zone in the preferences
 * 
 * This class is taken from : http://robobunny.com/wp/2011/08/13/android-seekbar-preference/
 *  
 */
